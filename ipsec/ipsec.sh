...
repo="raw.githubusercontent.com/YogzSC/scvip/main"
...
wget -O /usr/bin/addl2tp ${repo}/ipsec/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp ${repo}/ipsec/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp ${repo}/ipsec/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp ${repo}/ipsec/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp ${repo}/ipsec/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp ${repo}/ipsec/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
wget -O /var/lib/crot/data-user-l2tp "${repo}/ipsec/l2tp-user.sh"
wget -O /var/lib/crot/data-user-pptp "${repo}/ipsec/pptp-user"
