...
wger -q -O /usr/bin/tendang "${repo}/limit/tendang.sh"
...
wget -q -O /etc/slowdns/server.key "${repo}/SLDNS/server.key"
wget -q -O /etc/slowdns/server.pub "${repo}/SLDNS/server.pub"
wget -q -O /etc/slowdns/sldns-server "${repo}/SLDNS/sldns-server"
wget -q -O /etc/slowdns/sldns-client "${repo}/SLDNS/sldns-client"
cd
