...
wget -O /etc/pam.d/common-password "${repo}/Insshws/password.txt"
...
cd
cd
wget -O /usr/bin/badvpn-udpgw ${repo}/udpgw/badvpn-udpgw && chmod +x  /usr/bin/badvpn-udpgw
#system badvpn 7300
wget -O /etc/systemd/system/svr-7300.service ${repo}/udpgw/svr-7300.service && chmod +x  /etc/systemd/system/svr-7300.service
#system badvpn 7200
wget -O /etc/systemd/system/svr-7200.service ${repo}/udpgw/svr-7200.service && chmod +x  /etc/systemd/system/svr-7200.service
#system badvpn 7100
wget -O /etc/systemd/system/svr-7100.service ${repo}/udpgw/svr-7100.service && chmod +x  /etc/systemd/system/svr-7100.service
...
wget -q -O /etc/cyber.site "${repo}/issue.net"
...
wget ${repo}/Insshws/bbr.sh && chmod +x bbr.sh && ./bbr.sh
